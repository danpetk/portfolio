    ...
    return (
        ...
        <div className=" text-white text-3xl text-center leading-snug container mt-6 overflow-visible px-16 md:px-32 font-jetbrains mb-6">
            <div className='w-[100%] overflow-visible flex flex-col items-center'>
                <div className='topinfo'>I'm Daniel Petkoski, a computer science graduate with a minor in math and a passion for programming!</div><br></br>
                <div className='midinfo'>I have experience with everything from low-level programming with C++ to machine learning with Python to frontend development with JavaScript. I'm always learning new technologies and expanding what I know. No matter what I work on, I strive to write good code.</div><br></br>
